...
public class Pong implements Juego {
    ...
    private Paleta paleta1 = new Paleta("imagenes/pelota.png", WIDTH, HEIGHT);
    private Paleta paleta2 = new Paleta("imagenes/pelota.png", WIDTH, HEIGHT);
    ...
    */
    ...
    public void actualizar(double delta) {
        ...
        if (contador1 >= 10 || contador2 >= 10) {
            ...
            if (replay.contains(this.mouse.getX(), this.mouse.getY())) {
                System.out.println(".");
            }
            if (replay.contains(this.mouse.getX(), this.mouse.getY()) && this.mouse.isLeftButtonPressed()) {
                estado = ESTADO_ESPERANDO;
                contador1 = 0;
                contador2 = 0;
            }
